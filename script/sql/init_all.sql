...
CREATE TABLE `CORE_SHOP`  (
  ...
  `modify_man` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `deleted` tinyint(2) NULL DEFAULT NULL,
  `name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '名称',
  `logo` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'Logo',
  `banner` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'Banner',
  `summary` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '简介',
  `notice` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '公告',
  `scope` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '经营范围',
  `address` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '地址',
  `telephone` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '电话',
  `hours` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '营业时间',
  `return_address` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '退货地址',
  ...
  `enterprise` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '企业名称',
  `license_num` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '营业执照号',
  `license_pic` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '营业执照图',
  `corporation_name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '法人姓名',
  `corporation_card` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '法人身份证号',
  `corporation_pic` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '法人身份证图',
...
CREATE TABLE `CORE_SHOP_FLOW`  (
  ...
  `order_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '订单号',
  `payment_type` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付方式',
  `payment_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付流水',
  `product_name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品名称',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态 1,0',
  `type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '类型',
...
CREATE TABLE `CORE_SHOP_KEEPER`  (
  ...
  `modify_man` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `deleted` tinyint(2) NULL DEFAULT NULL,
  `account` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '账号',
  `password` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '密码',
  `nickname` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '昵称',
  `avatar` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '头像',
  `access_token` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '令牌',
  `access_expired` datetime(0) NULL DEFAULT NULL COMMENT '令牌时效',
  `register_ip` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '注册IP',
  `login_date` datetime(0) NULL DEFAULT NULL COMMENT '最后登录时间',
  `login_ip` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '最后登录IP',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态 1,0',
  `shop_id` bigint(20) NULL DEFAULT NULL COMMENT '店铺ID',
  `role` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '角色',
  `remark` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `CORE_SHOP_WITHDRAW`  (
  ...
  `shop_keeper_account` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '店员账号',
  `amount` decimal(16, 2) NULL DEFAULT NULL COMMENT '金额',
  `arrival_amount` decimal(16, 2) NULL DEFAULT NULL COMMENT '到账金额',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态',
  `pay_type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付方式',
  `pay_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付流水',
  `pay_date` datetime(0) NULL DEFAULT NULL COMMENT '支付时间',
  `pay_account` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付账号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_shop_id`(`shop_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
CREATE TABLE `LOG_SMS`  (
  ...
  `modify_date` datetime(0) NULL DEFAULT NULL,
  `modify_man` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `mobile` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '手机号',
  `code` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '验证码',
  `ip` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'IP地址',
...
CREATE TABLE `M_ADDRESS`  (
  ...
  `member_account` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '会员账号',
  `code` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '行政编码',
  `province` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '省份',
  `city` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '城市',
  `district` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '区县',
  `address` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '地址',
  `name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '姓名',
  `mobile` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '手机',
...
CREATE TABLE `M_MEMBER`  (
  ...
  `login_ip` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '最后登录IP',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态 1,0',
  `sex` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '性别',
...
CREATE TABLE `M_MEMBER_COUPON`  (
  ...
  `modify_man` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `shop_id` bigint(20) NULL DEFAULT NULL COMMENT '店铺ID',
  `shop_name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '店铺名',
  `member_id` bigint(20) NULL DEFAULT NULL COMMENT '会员ID',
...
CREATE TABLE `M_OAUTH`  (
  ...
  `modify_date` datetime(0) NULL DEFAULT NULL,
  `modify_man` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `channel` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '渠道',
  `open_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'openID',
  `union_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'unionID',
  `nickname` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '昵称',
  `avatar` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '头像',
  `access_token` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '令牌',
  `access_expired` datetime(0) NULL DEFAULT NULL COMMENT '令牌时效',
  `account` varchar(120) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '绑定账号',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `O_CART_ITEM`  (
  ...
  `standard` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品规格',
  `product_name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品名称',
  `product_pic` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商品图片',
...
CREATE TABLE `O_CROWD_GROUP`  (
  ...
  `deadline` datetime(0) NULL DEFAULT NULL COMMENT '过期时间',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态',
  `avatars` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '头像列表',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
CREATE TABLE `O_ORDER`  (
  ...
  `sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '订单号',
  `type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '类型',
  `status` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '状态',
  ...
  `payment_type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付方式',
  `payment_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付流水',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `O_ORDER_ITEM`  (
  ...
  `crowd_id` bigint(20) NULL DEFAULT NULL COMMENT '拼团团ID',
  `logistics_com` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '物流公司',
  `logistics_num` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '物流单号',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `O_PAYMENT`  (
  ...
  `deleted` tinyint(2) NULL DEFAULT NULL,
  `order_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '订单号',
  `trade_type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付场景',
  `payment_type` varchar(60) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付方式',
  `payment_sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付流水',
  `prepay_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '预付单ID',
  `app_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '应用号ID',
  `mch_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '商户号ID',
  `open_id` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'openID',
  `status` tinyint(2) NULL DEFAULT NULL COMMENT '状态',
...
CREATE TABLE `P_COUPON`  (
  ...
  `remark` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '备注说明',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_shop_id`(`shop_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
CREATE TABLE `P_PRODUCT`  (
  ...
  `deleted` tinyint(2) NULL DEFAULT NULL,
  `shop_id` bigint(20) NULL DEFAULT NULL COMMENT '店铺ID',
  `sn` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '条码',
  `name` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '名称',
  `pic` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '图片',
  ...
  `description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '描述',
  ...
  `crowd_group_time` int(10) NULL DEFAULT NULL COMMENT '拼团的成团时间',
...
CREATE TABLE `P_PRODUCT_SKU`  (
  ...
  `shop_id` bigint(20) NULL DEFAULT NULL COMMENT '店铺ID',
  `product_id` bigint(20) NULL DEFAULT NULL COMMENT '商品ID',
  `standard` varchar(180) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '规格',
