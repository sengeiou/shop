package com.d2c.shop.modules.logger.nosql.mongodb.document;
...
public class UserOperateLog implements IUoLog, Serializable {
    ...
    public String getTypeName() {
        ...
        return UserOperateLog.TypeEnum.valueOf(type).getDescription();
    }

    public String getTargetName() {
        if (StrUtil.isBlank(target)) return "";
        return UserOperateLog.TargetEnum.valueOf(target).getDescription();
    }
